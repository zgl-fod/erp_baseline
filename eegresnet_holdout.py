...
model = EEGResNet(n_chans, n_classes, final_pool_length='auto', input_window_samples=187, n_first_filters= 16)
# print(model)
model.to(device)
...
class BCEFocalLoss(torch.nn.Module):
    ...
    def __init__(self, gamma=2, alpha=0.19, reduction='elementwise_mean'):
        super().__init__()
        self.gamma = gamma
        self.alpha = alpha
